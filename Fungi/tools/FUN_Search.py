...
def parse_args():
    ...
    parser.add_argument("-i", "--input", required=True, help="Path to FUNGuild output file")
    parser.add_argument("-o", "--output", required=True, help="Path to save the results")
...
# Identify species in guild output 
def res_tsv(args):
    # Load TSV file 
    try:
    ...
    # Convert only abundance columns to float
    try:
