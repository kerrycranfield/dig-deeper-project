...
Shannon entropy revealed significant overall differences (p = 0.001), with green hay/bush sites showing higher diversity than both natural regeneration (q = 0.0019) and seed mix sites (q = 0.036). Seed mix sites also had higher Shannon diversity than natural regeneration (q = 0.0199).
...
Bray-Curtis-based PERMANOVA revealed significant differences in bacterial community composition across establishment methods (pseudo-F = 3.78, p = 0.001), with all pairwise comparisons between methods also significant (q < 0.005). These results indicate that restoration strategy has a strong influence on both the composition and abundance structure of bacterial communities.

Site age also had a significant but weaker effect (pseudo-F = 1.97, p = 0.037, q = 0.035). However, clustering by age in Bray-Curtis PCoA plots was less pronounced, suggesting more subtle shifts in community structure over time.

Soil pH significantly shaped bacterial community composition (pseudo-F = 3.858, p = 0.001), with Bray-Curtis PCoA plots showing clear clustering between high and low-to-neutral pH soils
