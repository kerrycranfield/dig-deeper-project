...
A total of **330 soil samples** were collected for each marker. Sequencing produced an average of approximately **65,000 reads per sample**, though this varied across the dataset:
...
<div style="text-align: center;">
  <a href="data/multiqc_report.html" target="_blank">
    <img src="images/sequence_quality_hist.png" style="max-width: 80%; height: auto;" alt="MutlitQc thumbnail">
  </a>
  <p style="font-style: bold;">Figure ??. MultiQC Plot</p>
</div>
')
...
df <- read.delim("data/s04_stats_dada2/data/metadata.tsv", comment.char = "#")

cat('Here is a link to the **statistics after denoising** to view it on QIIME2 (16S) : <a href="data/s04_stats_dada2/data/index.html" target="_blank">Statitics after denoising (16S)</a>')
...
htmltools::div(style = "text-align: center;", ggplotly(g, tooltip = "text"))
HTML("<p style='text-align: center; font-weight: bold;'>Figure 10. Shannon Index by Establishment</p>")
htmltools::div(style = "text-align: center;", ggplotly(gg, tooltip = "text"))
HTML("<p style='text-align: center; font-weight: bold;'>Figure 11. Faith PD by Establishment</p>")
...
pp <- ggplot(df_faith, aes_string(x = var, y = "faith_pd")) +
    geom_boxplot(fill = "deepskyblue3") +
    theme_minimal() +
    labs(x = var, y = "Faith PD") +
    theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  scale_y_continuous(breaks = seq(floor(min(df_faith$faith_pd, na.rm = TRUE)),
                                  ceiling(max(df_faith$faith_pd, na.rm = TRUE)), 1))

f <- ggplotly(p, tooltip = "text")
h <- ggplotly(pp, tooltip = "text")
cat('<div id="plot_year_est" style="display:none;">')
htmltools::div(style = "text-align: center;", f)
HTML("<p style='text-align: center; font-weight: bold;'>Figure 8. Shannon Index by Age of Establishment</p>")
htmltools::div(style = "text-align: center;", h)
HTML("<p style='text-align: center; font-weight: bold;'>Figure 9. Faith PD by Age of Establishment</p>")
...
htmltools::div(style = "text-align: center;", ggplotly(q, tooltip = "text"))
HTML("<p style='text-align: center; font-weight: bold;'>Figure 12. Shannon Index by Age</p>")
htmltools::div(style = "text-align: center;", ggplotly(qq, tooltip = "text"))
HTML("<p style='text-align: center; font-weight: bold;'>Figure 13. Faith PD by Age</p>")
...
p2 <- ggplot(shannon_merged, aes(x = Establishment, y = Shannon, fill = Establishment)) +
  ...
  theme_minimal() +
  labs(x = "Establishment",
       y = "Shannon Index") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))



cat('<div id="plot_estITS" >')
htmltools::div(style = "text-align: center;", ggplotly(p2, tooltip = "text"))
HTML("<p style='text-align: center; font-weight: bold;'>Figure 15. Shannon Index by Establishment</p>")
...
cat('<div id="plot_year_estITS" style="display:none;">')
htmltools::div(style = "text-align: center;", ggplotly(p1, tooltip = "text"))
HTML("<p style='text-align: center; font-weight: bold;'>Figure 14. Shannon Index by Age of Establishment</p>")
...
htmltools::div(style = "text-align: center;", ggplotly(p3, tooltip = "text"))
HTML("<p style='text-align: center; font-weight: bold;'>Figure 16. Shannon Index by Age</p>")
...
htmltools::div(style = "text-align: center;", b)
HTML("<p style='text-align: center; font-weight: bold;'>Figure 18. Weighted Unifrac Emperor Plot</p>")
...
<div style="text-align: center;">
  ...
  <p style="font-style: bold;">Figure 19. Krona Plot for Baltic_farm_1</p>
</div>
')
```
